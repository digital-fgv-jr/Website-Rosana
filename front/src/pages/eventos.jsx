      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-24">
        ...
        <section className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex-1">
            <h2 className="text-4xl font-BodoniMT text-[#1c2c3c] mb-4">
              Participar de um evento é sempre mais do que expor joias
            </h2>
            <p className="text-lg text-[#1c2c3c] leading-relaxed">
            ...
            <p className="text-lg text-[#1c2c3c] leading-relaxed mt-4">
          ...
          <div className="flex-1 flex flex-col gap-4">
            <img src="/eventos1.jpg" alt="Evento 1" className="w-full h-[250px] object-cover rounded-lg" />
            <img src="/eventos2.jpg" alt="Evento 2" className="w-full h-[250px] object-cover rounded-lg" />
          </div>
        </section>
        ...
        <section className="flex flex-col md:flex-row-reverse gap-8 items-center">
          ...
          {/* Imagens */}
          <div className="flex-1 flex flex-col gap-4">
            <img src="/eventos3.jpg" alt="Evento 3" className="w-full h-[250px] object-cover rounded-lg" />
            <img src="/eventos4.jpg" alt="Evento 4" className="w-full h-[250px] object-cover rounded-lg" />
          </div>
        </section>
      </div>
      </main>
