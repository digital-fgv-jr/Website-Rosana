...
export default function CriadasParaVoce() {
    return (
      <div>
          ...
          <h1 className="text-4xl font-bold text-gray-800">Criadas Para Você</h1>
          <p className="mt-4 text-lg text-gray-600">Cada joia tem uma história única</p>
      </div>
      ...
      <div className="lg:w-1/2">
          <img src="/blocoimg1.jpg" alt="Joia personalizada 1" className="w-full h-auto rounded" />
      </div>
      </div>
      <div className="flex flex-col lg:flex-row items-center gap-8 my-12 max-w-6xl mx-auto">
      <div className="lg:w-1/2 flex flex-col gap-4">
    <img src="/blocoimg2.jpg" alt="Joia personalizada 2" className="w-full h-auto rounded" />
    <img src="/blocoimg3.jpg" alt="Joia personalizada 3" className="w-full h-auto rounded" />
    </div>
      <div className="lg:w-1/2">
       <p className="text-gray-700">
          Cada joia personalizada é um diálogo entre a sua história e as mãos
    ...
    <div className="text-center my-12">
  <button
    className="px-6 py-3 bg-[#1c2c3c] text-white font-medium rounded-lg shadow hover:bg-[#25384d] transition"
